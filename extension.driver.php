<?php
	...
	final class Extension_Frontend_Localisation extends Extension
	{
		...
		private function _appendMainLang(&$wrapper, $context){
			...
			$all_languages = Languages::local()->listAll();
		...
		public function dSave(array $context){
			...
			$errors = & $context['errors']['frontend_localisation'];
			...
			unset($context['settings']['frontend_localisation']['langs']);
			...
			$main_lang = FLang::getMainLang();
			unset($context['settings']['frontend_localisation']['main_lang']);
